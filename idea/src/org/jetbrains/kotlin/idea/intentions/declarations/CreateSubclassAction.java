...
//
//        JavaLanguage getLanguage();
//
//        boolean isInterface();
//
//        boolean hasModifierProperty(String anAbstract);
//
//        MyClass getContainingClass();
//
//        Project getProject();
//
//        PsiTypeParameterList getTypeParameterList();
//
//        MyClass addAfter(MyClass text, MyClass aClass);
//
//        String getName();
//
...
//        MyClass psiClass = getParentClass(element);
//        if (psiClass == null || psiClass.isAnnotationType() || psiClass.isEnum() || psiClass.isAnonymousClass() ||
//            psiClass.isFinal() || file.getContainingFile().getContainingDirectory() == null) {
//            return false;
//        }
...
//
//        TextRange declarationRange = getDeclarationRange(psiClass);
...
//    }
//
//    protected boolean isSupportedLanguage(MyClass aClass) {
//        return aClass.getLanguage() == JavaLanguage.INSTANCE;
//    }
//
//    protected static String getTitle(MyClass psiClass) {
...
//        final MyClass psiClass = getParentClass(element);
//
...
//    }
//
//    public static void createInnerClass(final MyClass aClass) {
//        new WriteCommandAction(aClass.getProject(), getTitle(aClass), getTitle(aClass)) {
//            @Override
//            protected void run(@NotNull Result result) throws Throwable {
//                final MyClass containingClass = aClass.getContainingClass();
//                LOG.assertTrue(containingClass != null);
//
//                final PsiTypeParameterList oldTypeParameterList = aClass.getTypeParameterList();
//                MyClass classFromText = createClass(aClass);
//                classFromText = containingClass.addAfter(classFromText, aClass);
//                startTemplate(oldTypeParameterList, aClass.getProject(), aClass, classFromText, true);
//            }
//        }.execute();
//    }
//
//    protected void createTopLevelClass(MyClass psiClass) {
...
//
//    @Nullable
//    public static CreateClassDialog chooseSubclassToCreate(MyClass psiClass) {
...
//                CreateClassKind.CLASS, true, findModuleForPsiElement(psiClass)) {
//            @Override
...
//    }
//
//    public static MyClass createSubclass(final MyClass psiClass, final PsiDirectory targetDirectory, final String className) {
//        final Project project = psiClass.getProject();
//        final MyClass[] targetClass = new MyClass[1];
...
//
//                try {
//                    targetClass[0] = createClass(targetDirectory, className);
//                }
...
//
//            final Editor editor = positionCursorAtLBrace(
//                    positionCursorAtLBrace(project, targetClass[0]), targetClass[0]);
...
//    }
//
//    private static Editor positionCursorAtLBrace(Editor editor, MyClass clas) {
//        return editor;
//    }
//
//    private static void startTemplate(PsiTypeParameterList oldTypeParameterList,
//            final Project project,
//            final MyClass psiClass,
//            final MyClass targetClass,
//            final boolean includeClassName) {
//        final PsiElementFactory elementFactory = JavaPsiFacade.getInstance(project).getElementFactory();
//        PsiJavaCodeReferenceElement ref = createClassReferenceElement(psiClass);
//        try {
...
//                final Editor editor = positionCursorAtLBrace(project, targetClass);
//                final TemplateBuilderImpl templateBuilder = editor != null
//                                                            ? createTemplateBuilder(targetClass) : null;
//
...
//                                final MyClass aTargetClass = getParentClass(psiElement);
...
//    }
//
//    private static PsiElement replaceTypeParamsList(MyClass psiClass, PsiTypeParameterList oldTypeParameterList) {
...
//    }
//
//    protected static void chooseAndImplement(MyClass psiClass, Project project, @NotNull MyClass targetClass, Editor editor) {
...
//                if (isAccessible(project, targetClass, baseConstr)) {
...
//
//    @NotNull
//    private TextRange getDeclarationRange(MyClass psiClass) {
//        return HighlightNamesUtil.getClassDeclarationTextRange(psiClass);
//    }
//
//    private static MyClass getParentClass(PsiElement element) {
//        return PsiTreeUtil.getParentOfType(element, PsiClass.class);
//    }
//
//    @NotNull
//    private static MyClass createClass(MyClass aClass) {
//        return JavaPsiFacade.getElementFactory(aClass.getProject()).createClass(aClass.getName() + IMPL_SUFFIX);
//    }
//
//    @NotNull
//    private static MyClass createClass(PsiDirectory targetDirectory, String className) {
//        return JavaDirectoryService.getInstance().createClass(targetDirectory, className);
//    }
//
//    private static TemplateBuilderImpl createTemplateBuilder(MyClass targetClass) {
//        return (TemplateBuilderImpl) TemplateBuilderFactory
//                .getInstance().createTemplateBuilder(targetClass);
//    }
//
//    private static PsiJavaCodeReferenceElement createClassReferenceElement(MyClass psiClass) {
//        final PsiElementFactory elementFactory = JavaPsiFacade.getInstance(project).getElementFactory();
//        return elementFactory.createClassReferenceElement(psiClass);
//    }
//
//    private static Module findModuleForPsiElement(MyClass psiClass) {
//        return ModuleUtilCore.findModuleForPsiElement(psiClass);
//    }
//
//    private static Editor positionCursorAtLBrace(Project project, MyClass targetClass) {
//        return CodeInsightUtil.positionCursorAtLBrace(project, targetClass.getContainingFile(), targetClass);
//    }
//
//    private static boolean isAccessible(Project project, @NotNull MyClass targetClass, PsiMethod baseConstr) {
//        return PsiUtil.isAccessible(project, baseConstr, targetClass, targetClass);
//    }
//
//    private static void chooseAndImplementMethods(Project project, @NotNull MyClass targetClass, Editor editor) {
